...
- main:
  ...
  - paragraph: "The following properties on element kanban-board will not trigger updates as expected because they are set using class fields: tasks, agents, offline, filter, agentFilter, priorityFilter, roleFilter, showOnlyUnassigned, draggedTask, isUpdating, selectedTasks, bulkActionPanel, taskAnalytics. Native class fields and some compiled output will overwrite accessors used for detecting changes. See https://lit.dev/msg/class-field-shadowing for more information."
  - button "Reload Page":
    - img
    - text: Reload Page
  - button "Go Home":
